...
function script_load(settings)
    ...
    hotkey_pause_id = obslua.obs_hotkey_register_frontend("stitcher_pause", "Auto-Stitch: Fake Pause/Unpause", trigger_pause)
    hotkey_cut10_id = obslua.obs_hotkey_register_frontend("stitcher_cut10", "Auto-Stitch: Cut Last 10s", trigger_cut_10)
    hotkey_cut30_id = obslua.obs_hotkey_register_frontend("stitcher_cut30", "Auto-Stitch: Cut Last 30s", trigger_cut_30)
